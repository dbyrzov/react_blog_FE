...
const Blog: React.FC<any> = (props) => {
  ...
  let imageUrl = 'url("https://localhost:3000/images/';
  ...
  function shareFacebook() {
    ...
    <html lang="en">
      <head>
        ...
        <meta name="description" content="mitko"/>
        <meta property="fb:app_id"             content='512801023252803' />
        <meta property="og:url"                content='https://localhost:3000/blogs/blog?id=111' />
        <meta property="og:type"               content="website" />
        <meta property="og:title"              content="${stBlog.title}" />
        <meta property="og:description"        content="${stBlog.description}" />
        <meta property="og:image"              content="https://localhost:3000/images/${stBlog.image}" />
        <title>mitko2</title>
      </head>
      <body>
        <script>
          window.open('https://www.facebook.com/dialog/share?app_id=512801023252803&href=https://localhost:3000/blogs/blog?id=112&feature=share&display=popup', '_self');
        </script>
      </body>
    </html>
    `;
    ...
    let facebookLink = `https://www.facebook.com/dialog/share?app_id=512801023252803&href=https://localhost:3000/share/facebook/blogs/${stBlog.blog_id}.html
    &display=popup`;
