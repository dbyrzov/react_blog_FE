...
const Navbar: React.FC = () => {
  ...
  return (<>
    <div className={styles.navbar}>
      <img className={styles.navLogo} src={require('../../../../images/basket.png')} alt="" onClick={gotoHome}/>
            ...
            <Card raised={true} variant="outlined" className={styles.basketPopup}>
              {
                ctx.orderProducts.map( (res:ProductModel) => 
                  <Card key={res.product_id} className={styles.cartCard}>
                    {/* <div className={styles.basketImage} style={{backgroundImage: `url("https://localhost/images/${res.image}")`}}></div> */}
                    <div className={styles.basketImage} style={{backgroundImage: `url("/images/${res.image}")`}}></div>
